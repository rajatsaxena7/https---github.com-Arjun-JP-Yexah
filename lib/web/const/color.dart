...
class ColorConst {
  static const Color scaffoldDark = Color.fromARGB(255, 34, 39, 54);
  static const Color scaffoldDarklite = Color.fromARGB(110, 34, 39, 54);
  static const Color scaffoldlite = Colors.white;
  static const Color dealdark = Color.fromARGB(255, 255, 114, 33);
  static const Color deallite = Color.fromARGB(255, 255, 94, 0);
  static const Color rightcontainerdark = Color(0xff323a4d);
  static const Color rightcontainerlite = Color(0xFFe8ecef);
  static const Color textdarkw = Colors.white;
  static const Color textliteb = Colors.black;

  static const Color gold = Color.fromARGB(255, 170, 185, 6);
  static const Color blueBg = Color.fromARGB(255, 67, 212, 231);
  static const Color cardBackground = Color.fromARGB(255, 253, 253, 253);
  static const Color warningRed = Color.fromARGB(255, 255, 0, 0);
  ...
  static const Color primary = Color.fromARGB(255, 34, 129, 75);
  static const Color primaryLight = Color.fromARGB(255, 147, 211, 175);
  static const Color secondary = Color.fromARGB(255, 255, 114, 33);
  static const Color secondaryDark = Color.fromARGB(255, 255, 94, 0);
  static const Color primaryDark = Color.fromARGB(255, 54, 64, 152);
  static const Color appbarLightBG = Color(0xFFE9E9EF);
  static const Color drawerBG = Color.fromARGB(255, 255, 255, 255);
  ...
  static const Color greyishBackgroundColour = Color(0xFFE9ECEF);
  ...
  static const Color offWhite = Color.fromARGB(255, 235, 235, 237);

...
class TransactionCustomer extends StatefulWidget {
  ...
  const TransactionCustomer({super.key, required this.ctx});

  @override
  State<TransactionCustomer> createState() => _TransactionCustomerState();
}
...
class _TransactionCustomerState extends State<TransactionCustomer> {
  @override
  void initState() {
    fetchData();
    super.initState();

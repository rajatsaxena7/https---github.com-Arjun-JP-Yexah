...
class ReportCustomer extends StatefulWidget {
  ...
  const ReportCustomer({super.key, required this.ctx});
...
class _ReportCustomerState extends State<ReportCustomer> {
  ...
  final List<Map<String, String>> dataList2 = [
    {
      'Sno': 'Transaction Report',
      'Channel': 'Generated: 5th July',
      'CustomerName': 'Tarun Singh',
    },
    {
      'Sno': 'Service Request Report',
      'Channel': 'Generated: 7th July',
      'CustomerName': 'Smarth',
    },
        ...
        child: Column(
          ...
          children: [
            Texttxt(
                color: isdark ? ColorConst.textdarkw : ColorConst.textliteb,
                fontsize:
                    isMobileView(context) ? 12 : screenwidth(context) * .011,
  ...
  Widget _RecentReporttable() => Padding(
        padding: const EdgeInsets.only(left: 20, right: 20),
        child: Container(
          padding: const EdgeInsets.all(10),
          width: isMobileView(context)
            ...
            children: [
              ...
              Center(
                child: SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  child: DataTable(
                    columnSpacing: screenwidth(context) * .2,
                    columns: [
                      DataColumn(
                          label: Text(
                        ' ',
